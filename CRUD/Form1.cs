...
namespace CRUD
{
    public partial class txtFN : Form
    {
        ...
        {
            Conexion.Conectar();
            string insertar = "INSERT INTO ESTUDIANTES(ID, primer_Nom,segundo_Nom,primer_Ape,segundo_Ape,telefono, celular,direccion,email,fechaNacimiento,observaciones) values" +
                "(@ID,@primer_Nom,@segundo_Nom,@primer_Ape,@segundo_Ape,@telefono, @celular,@direccion,@email,@fechadeNacimiento,@observaciones)";
            ...
            try
            {
                ...
                cmd1.Parameters.AddWithValue("@primer_Nom", Nom1);
                cmd1.Parameters.AddWithValue("@segundo_Nom", Nom2);
                cmd1.Parameters.AddWithValue("@primer_Ape", ape1);
                cmd1.Parameters.AddWithValue("@segundo_Ape", ape2);
                ...
                cmd1.Parameters.Add(new SqlParameter("@fechadeNacimiento", SqlDbType.DateTime)).Value = dateTimePicker1.Value.Date;
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                string Eliminar = "delete from ESTUDIANTES where ID= @ID";
        ...
        {
            Conexion.Conectar();
            string Actualizar = "UPDATE ESTUDIANTES SET primer_Nom = @primer_Nom,segundo_Nom = @segundo_Nom,primer_Ape = @primer_Ape,segundo_Ape = @segundo_Ape," +
                "telefono=@telefono , celular=@celular , direccion=@direccion , email=@email , fechaNacimiento=@fechaNacimiento , observaciones=@observaciones" +
                " where ID = @ID";
            try
            {
                ...
                cmd3.Parameters.AddWithValue("@primer_Nom", Nom1);
                cmd3.Parameters.AddWithValue("@segundo_Nom", Nom2);
                cmd3.Parameters.AddWithValue("@primer_Ape", ape1);
                cmd3.Parameters.AddWithValue("@segundo_Ape", ape2);
                ...
                cmd3.Parameters.Add(new SqlParameter("@fechaNacimiento", SqlDbType.DateTime)).Value = dateTimePicker1.Value.Date;
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            oRep.Load(@"C:\Users\Use\Desktop\SENATI\smtr_4\Lenguaje_de_Programacion\tareas\CRUD\CRUD\CrystalReport1.rpt");
            reportForm.crystalReportViewer1.ReportSource = oRep;
            reportForm.Show();
        }
    }
}
